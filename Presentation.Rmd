...
As you can see, there are some confounding factors to interference the judgement which are important features for patient survive or not. And also It is hard to determine that cancer results in death or treatment improve rate of survival. There are some competing events. Before getting results, we don't know the cause of death. 
